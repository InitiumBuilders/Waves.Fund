...
export const SHARE_PAGES = [
  ...
  { route: "/give", file: "share/give.html", title: "Funding The Future Together | Waves.Fund", description: "Direct energy with intention. Give time, mentorship, funding, or a signal." },
