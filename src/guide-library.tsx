...
export function GuidePitch() {
  return <div className="document-page guide-public">
    <div className="guide-pitch-hero"><Intro eyebrow="THE HUMAN IN THE LOOP" title={<>Your vision.<br />Your Wave.<br /><span>A Guide beside you.</span></>}><p>A Wave Guide works with you to design, build, and evolve a custom home for your mission—its story, its people, and its next move.</p></Intro><div className="guide-human-orbit" aria-hidden="true"><div className="guide-orbit-ring" /><WaveMark /><span>Wave Guides</span><i /><i /></div></div>
...
export function GuideLibrary() {
  return <div className="document-page guide-public">
    ...
    <Intro eyebrow="THE WAVE GUIDE LIBRARY" title={<>Learn the practice.<br /><span>Build it together.</span></>}><p>A practical foundation for the human in the loop. Listen deeply. Build something useful. Help people move together. Show what changed.</p></Intro>
